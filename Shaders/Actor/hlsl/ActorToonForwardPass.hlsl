#ifndef ROXAMI_ACTOR_FORWARD_PASS_INCLUDED
#define ROXAMI_ACTOR_FORWARD_PASS_INCLUDED
...
Varyings ActorToonForwardPassVertex(Attributes input)
{
...
half4 ActorSkinForwardPassFragment(Varyings input) : SV_Target
{
    UNITY_SETUP_INSTANCE_ID(input);
    UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(input);

    SurfaceData surfaceData = (SurfaceData) 0;
    surfaceData.albedo = SampleAlbedoAlpha(input.uv, _BaseMap, sampler_BaseMap);
